        ...
        <div class="bg-white shadow-sm rounded-1 p-3">
            ...
            <div  v-if="tab == `Colors`">
                ...
                <div class="row mx-0 mt-5">
                    ...
                    <div class="col-md-6">
                        <button @click="tab=`Identity`" class="btn btn-primary btn-sm"><span class="fa fa-arrow-left"></span> Previous</button>
                    </div>
                    <div class="col-md-6">
...
export default {
    ...
    methods:{
        ...
        addSizes(color_id){
            this.$modal.show(
                addSizesModalVue,
                {color_id:color_id, product_id:this.$route.params.id },
                {height:"auto", width:"500px"},
                {"closed":this.getColors}
            )
        },
        async getColors(){
            await axios.get('/getColorsData/'+this.$route.params.id )
            .then( response =>{
        ...
        async deleteProduct(){
            await axios.delete('/products/'+this.$route.params.id)
            .then( response =>{
        ...
        async publishProduct(){
            ...
            await axios.post('/publishProduct', {p_id:this.$route.params.id})
            .then( response =>{
                this.$notify({
                    group: 'foo',
                    type: 'success',
        ...
        async getPInventory(){
            await axios.get('/getColorInventory/'+this.$route.params.id)
            .then( response =>{
        ...
        async getPreviewData(){
            await axios.get('/getPreviewData/'+this.$route.params.id)
            .then( response =>{
        ...
        async updateColors(){
            await axios.post('/updateColors', {colorData:this.colorData, product_id:this.$route.params.id})
            .then( response =>{
        ...
        async addIdentity(){
            await axios.put('/products/'+this.$route.params.id, this.productIdentity)
            .then( response =>{
                this.identityAdded = true
                this.tab = 'Colors'
                this.isEditing = true
        ...
        async getProduct(){
            ...
            .then( response =>{
                this.product = response.data
                this.productIdentity = response.data
            })
        },
        async getInventory(){
